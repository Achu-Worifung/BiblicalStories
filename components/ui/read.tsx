  ...
  return (
    <TracingBeam className="px-6">
      <div className="max-w-2xl mx-auto antialiased pt-4 relative">
        <h1 className="text-3xl font-bold mb-4">Noah's ark</h1>
        ...
        />
        <div className="text-gray-700 dark:text-gray-300 text-sm/7 [&>p]:mb-4 [&>p:first-of-type::first-letter]:text-4xl [&>p:first-of-type::first-letter]:text-emerald-500 [&>p:first-of-type::first-letter]:font-bold">
